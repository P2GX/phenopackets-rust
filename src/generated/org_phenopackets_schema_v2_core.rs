...
// ## Notes
// Support for (de)serialization with serde was added manually.
//
// ### Serialization
//
// #### Default values
...
pub struct TimeInterval {
    ...
    #[cfg_attr(
        feature = "serde",
        serde(
            serialize_with = "crate::serde::helpers::serialize_timestamp_option",
            skip_serializing_if = "Option::is_none",
            deserialize_with = "crate::serde::helpers::deserialize_timestamp_option",
            default,
        )
    )]
...
pub struct Interpretation {
    ...
    #[cfg_attr(
        feature = "serde",
        serde(
            serialize_with = "crate::serde::helpers::serialize_progress_status",
            deserialize_with = "crate::serde::helpers::deserialize_progress_status",
            default,
        )
    )]
...
pub struct GenomicInterpretation {
    ...
    #[cfg_attr(
        feature = "serde",
        serde(
            serialize_with = "crate::serde::helpers::serialize_interpretation_status",
            deserialize_with = "crate::serde::helpers::deserialize_interpretation_status",
            default,
        )
    )]
...
pub struct VariantInterpretation {
    ...
    #[cfg_attr(
        feature = "serde",
        serde(
            serialize_with = "crate::serde::helpers::serialize_acmg_pathogenicity_classification",
            deserialize_with = "crate::serde::helpers::deserialize_acmg_pathogenicity_classification",
            default,
        )
    )]
...
pub struct Individual {
    ...
    #[cfg_attr(
        feature = "serde",
        serde(
            serialize_with = "crate::serde::helpers::serialize_sex",
            deserialize_with = "crate::serde::helpers::deserialize_sex",
            default,
        )
    )]
    pub sex: i32,
    ...
    #[cfg_attr(
        feature = "serde",
        serde(
            serialize_with = "crate::serde::helpers::serialize_karyotypic_sex",
            deserialize_with = "crate::serde::helpers::deserialize_karyotypic_sex",
            default,
        )
    )]
...
pub struct VitalStatus {
    ...
    #[cfg_attr(
        feature = "serde",
        serde(
            serialize_with = "crate::serde::helpers::serialize_vital_status_status",
            deserialize_with = "crate::serde::helpers::deserialize_vital_status_status",
            default,
        )
    )]
    pub status: i32,
...
pub struct Treatment {
    ...
    #[cfg_attr(
        feature = "serde",
        serde(
            serialize_with = "crate::serde::helpers::serialize_drug_type",
            deserialize_with = "crate::serde::helpers::deserialize_drug_type",
            default,
        )
    )]
    pub drug_type: i32,
...
pub struct TherapeuticRegimen {
    ...
    #[cfg_attr(
        feature = "serde",
        serde(
            serialize_with = "crate::serde::helpers::serialize_regimen_status",
            deserialize_with = "crate::serde::helpers::deserialize_regimen_status",
            default,
        )
    )]
...
pub mod pedigree {
    ...
    pub struct Person {
        ...
        #[cfg_attr(
            feature = "serde",
            serde(
                serialize_with = "crate::serde::helpers::serialize_affected_status",
                deserialize_with = "crate::serde::helpers::deserialize_affected_status",
                default,
            )
        )]
